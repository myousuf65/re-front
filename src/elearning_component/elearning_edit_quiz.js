...
export default Form.create()(class ElearningCreateQuiz extends Component{
    ...
    render(){
        const { selPost, loading, ruleOptions, mode, disableTimePicker,quizOptions } = this.state;
                                        ...
                                        <Form layout="horizontal" labelAlign="left" onSubmit={this.handleSubmit}>
                                            ...
                                            <div>
                                                ...
                                                {getFieldDecorator('isPublic',{
                                                    initialValue: quizOptions.isPublic? !disableTimePicker:false,
                                                    valuePropName: 'checked'
                                                })(
                                                ...
                                                {getFieldDecorator('publishAt',{
                                                    initialValue: (quizOptions===undefined? moment() : moment(quizOptions.publishAt)), valueProName:'moment'})(
                                                    <DatePicker 
                                                    locale={locale}
