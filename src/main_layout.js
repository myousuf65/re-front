...
import { Layout, Menu, Spin, Input, Icon, Result, Button, Skeleton, Badge , Modal} from 'antd';
...
const ResourcesDetails = React.lazy(() => 
  import(/* webpackChunkName: 'ResourcesDetails' */ "./resources_component/resources_details")
);
const MiniblogHome = React.lazy(() => 
  import(/* webpackChunkName: 'MiniblogHome' */ "./miniblog_component/miniblog_home")
);
const PostDetails = React.lazy(() => 
  import(/* webpackChunkName: 'PostDetails' */ "./miniblog_component/miniblog_postdetails")
);
const PostCreator = React.lazy(() => 
  import(/* webpackChunkName: 'PostCreator' */ "./miniblog_component/miniblog_postcreator")
);
const ResourcesShowAll = React.lazy(() => 
  import(/* webpackChunkName: 'ResourcesShowAll' */ "./resources_component/resources_showall")
);
const ResourcesLatestNews = React.lazy(() => 
  import(/* webpackChunkName: 'ResourcesLatestNews' */ "./resources_component/resources_latestNews")
);
const AdminconsoleLayout = React.lazy(() => 
  import(/* webpackChunkName: 'AdminconsoleLayout' */ "./admin_console_component/admin_console_layout")
);
const MiniblogMyBlog = React.lazy(() => 
  import(/* webpackChunkName: 'MiniblogMyBlog' */ "./miniblog_component/miniblog_myblog")
);
const ResourcesCate = React.lazy(() => 
  import(/* webpackChunkName: 'ResourcesCate' */ "./resources_component/resources_category")
);
const PostEditor = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./miniblog_component/miniblog_posteditor")
);
const MyFavourites = React.lazy(() => 
  import(/* webpackChunkName: 'MyFavourites' */ "./home_component/my_favourites")
);
...
const MobileAppPage = React.lazy(() => 
  import(/* webpackChunkName: 'MobileAppPage' */ "./home_component/mobileAppDownload")
);
const NewsCornerHome = React.lazy(() => 
  import(/* webpackChunkName: 'NewsCornerHome' */ "./newscorner_component/newscorner_home")
);

const SpecialCollectionHome = React.lazy(() => 
  import(/* webpackChunkName: 'MiniblogHome' */ "./specialCollection_component/specialCollection_home")
);
const SpecialCollectionMySpecialCollection = React.lazy(() => 
  import(/* webpackChunkName: 'MiniblogMyBlog' */ "./specialCollection_component/specialCollection_mySpecialCollection")
);
const SpecialCollectionPostCreator = React.lazy(() => 
  import(/* webpackChunkName: 'PostCreator' */ "./specialCollection_component/specialCollection_postcreator")
);
const SpecialCollectionPostEditor = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./specialCollection_component/specialCollection_posteditor")
);
const ElearningHome = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./elearning_component/elearning_home")
);
const ElearningQuizList = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./elearning_component/elearning_quiz_list")
);
const ElearningQuiz = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./elearning_component/elearning_quiz")
);
const ElearningQuizResult = React.lazy(() => 
  import(/* webpackChunkName: 'PostEditor' */ "./elearning_component/elearning_quiz_result")
);
...
const celebrate100_logo = process.env.PUBLIC_URL + '/images/activity/100yr_logo.jpeg';
const adminIcon = process.env.PUBLIC_URL + '/images/icon-admin.png';



const userLevelBarLib = [
  { level: 1, style: {backgroundImage: "linear-gradient(to right, #dfe3ec 65%, #dbe3eb)"} }, 
  { level: 2, style: {backgroundImage: "linear-gradient(to right, #84ce98 65%, #bfedcc)"} },
  { level: 3, style: {backgroundImage: "linear-gradient(to right, #dcb65a 65%, #eae3b4)"} },
  { level: 4, style: {backgroundImage: "linear-gradient(to right, #b7c1c8 25%, #d5e0e6)", borderBottom: "5px solid #b2bec9"} },
  { level: 5, style: {backgroundImage: "linear-gradient(to right, #9fcff9 65%, #d0e3f5)", borderBottom: "5px solid #82add1"} },
]
...
class MainLayout extends React.Component{
  ...
  state = { 
    ...
    score: 0,
    inboxNotice: 0,
    userProfileImage: {background: "url(" + adminIcon + ") left center no-repeat"},
    myPetType: null,
    animatePet: false,
  };
    ...
    if(!sessionStorage.getItem('@userInfo.login')){
      ...
      this.fetchUser(res => {
        ...
        if(res.status===200&&res.data!==null){
          ...
          sessionStorage.setItem('@userInfo.profile_photo', res.data.profilePhoto||"");
          // sessionStorage.setItem('@userInfo.login_tries', res.loginTimes || 0);
          sessionStorage.setItem('@userInfo.login_last_try', res.data.loginLastTry);
          sessionStorage.setItem('lang', (res.data.lang==='tc'? 'zh_TW' : 'en_US') || 'en_US');
          sessionStorage.setItem('@userInfo.score', res.score || 0);
          sessionStorage.setItem('@userInfo.isBlogger', res.data.isBlogger || 0);
          sessionStorage.setItem('@userInfo.usergroup',res.data.usergroup);

          if(res.msg==='1'||res.msg==='2'||res.msg==='3'||res.msg==='4'){
          ...
          this.setState(state=>({ userlogined: currentUser, lang: sessionStorage.getItem('lang') }), ()=>this.checkInboxNotice());
          ...
          let getCateList_url = sessionStorage.getItem('serverPort')+'category/all';
      ...
      let currentUser = {
        ...
        login_last_try: parseInt(sessionStorage.getItem('@userInfo.login_last_try')),
      ...
      this.loadLocales();
      this.handleResCateId();
      this.setState(state=>({ userlogined: currentUser, lang: sessionStorage.getItem('lang') || 'en_US' }), ()=>this.checkInboxNotice());
      this.handleScoring(sessionStorage.getItem('@userInfo.score'));
  ...
  renderTopBarManually=()=>{
    if(sessionStorage.getItem('@userInfo.staffNo') !== '12132' && sessionStorage.getItem('@userInfo.staffNo') !== '13780' ){ return; }
  ...
  checkInboxNotice=()=>{
    ...
    if(!sessionStorage.getItem('@userInfo.id')){ return };
    let checkInbox_url = sessionStorage.getItem('serverPort')+'inbox/notice/'+sessionStorage.getItem('@userInfo.id')
    fetchData(checkInbox_url, 'get', null, response=>{
      if(response.ifSuccess){
        ...
        if(res.status===200&&res.data>-1){
          ...
          this.setState({ animatePet: true }, ()=>this.setState({ animatePet: false }))
        }
      }
    })
  }
  ...
  handleLastLoginTry = (staffNo) => {
    let getLastLogin_url = sessionStorage.getItem('serverPort')+'user/LoginLastTime/'+ staffNo;
  ...
  loadMenuOption(item){
    ...
    if (item.children === null || item.children.length === 0){
      optionItem = <Menu.Item className="nav-item" key={item.id} onClick={(e)=>{this.setState({menuHidden:true});this.handleCateShortcut(item.id);}}>{sessionStorage.getItem('lang')==='zh_TW'? item.nameTc: item.nameEn}</Menu.Item>;
    }
    else if (item.children.length > 0) {
      optionItem = item.children.map((child) => this.loadMenuOption(child));
      optionItem = <SubMenu className="nav-item some-align-left-class-name" key={item.id} onTitleClick={(e)=>{this.setState({menuHidden:true});this.handleCateShortcut(item.id);}} title={" < "+(sessionStorage.getItem('lang')==='zh_TW'? item.nameTc:item.nameEn)}>{optionItem} </SubMenu>;
    };
    return optionItem;
  }
  ...
  handleLangChange = (langOption) => {
    let setLang_url = sessionStorage.getItem('serverPort')+`user/changeLang/${sessionStorage.getItem('@userInfo.id')}/${langOption}`;
    fetchData(setLang_url, 'post', null, response=>{});
  }

  onSearch = (value) => {
    if(value !== undefined && value !== null && value.length > 0){
      var theURI = encodeURI(sessionStorage.getItem('serverPort') + "search/query?keyword=" + value + "&user_id=" + sessionStorage.getItem('@userInfo.id'));
  ...
  handleResCateId=()=>{
    ...
    let selCateId = winHref.slice(winHref.lastIndexOf("resources/category/")+19);
    ...
    showPopOut=()=>{
      let get_pop_url = sessionStorage.getItem('serverPort')+'popout/homepage/'+sessionStorage.getItem('@userInfo.id');
...
showNoticeModalForPwPolicy=()=>{
  Modal.confirm({
    ...
    content: (
      <div>
        <p><center><strong>Software Download</strong></center></p>
        <p> The latest version of KMS App has been launched.  Please update now. </p>
        <p><center><strong>軟件下載</strong></center></p>
...
checkMobileVersion =() =>{
  ...
  //if (tooltipTrigger ===true ){ 
    if ( 0===1){ 
      let get_app_version = sessionStorage.getItem('serverPort')+'mobile/check/'+sessionStorage.getItem('@userInfo.id')+'/'+osType;
...
preparePopOutModal=(imageUrl,hypryLink)=>{
  ...
  if (tooltipTrigger ===true ){
      ...
      console.log('main layout, line 581 : width = ', imageWidth, ' height = ',imageHeight);
      if (imageWidth<imageHeight){
        ...
        Modal.info({
          ...
          content: (
              ...
              <img src={imageUrl} style={{ width: 'auto', maxWidth: 'auto', height:'60vh', maxHeight:'60vh' }} alt="Notice"/>
              </a>
          ),
          okText: "Close 關閉"
      });
        ...
        Modal.info({
          ...
          content: (
              ...
              // <a href={(e)=>this.handleLink(hypryLink)} target="_blank"> 
              <a onClick={(e)=>this.handleLink(hypryLink)}>
              <img src={imageUrl} style={{ width: 'auto', maxWidth: '50vw', height:'auto' ,maxHeight:'70vh'}} alt="Notice"/>
              </a>
          ),
          okText: "Close 關閉"
      });
  ...
  render() {
    ...
    title={sessionStorage.getItem('lang')==='zh_TW'? "歡迎到訪懲教署知識管理系統":"Welcome to CSD Knowledge Management System"}
    />
    )
    ...
    // );
      ...
      const {userlogined, failedLogin, loadingMenu, level, score, navBarLevel, menuHidden, inboxNotice, myPetType, animatePet } = this.state;
      // const {userlogined, failedLogin, loadingMenu, level, score, navBarLevel, menuHidden, inboxNotice } = this.state;
      const accessMode = getAccessMode();
      const navbarTopStyle = userLevelBarLib.find(l => l.level === navBarLevel).style;
      ...
      return(
        <div>
          ...
          {this.state.initDone?
          // this.state.initDone &&
          <LocaleProvider locale={sessionStorage.getItem('lang')==='zh_TW'? zh_TW : en_US}>
            <Layout style={{ minHeight: '100vh', zIndex: 99 }}>
              
                  <nav className="navbar ftco_navbar ftco-navbar-light" id="ftco-navbar">
                    ...
                    <div className="container d-flex align-items-stretch">
                      <div className="col-12">
                        <ul className="navbar-top-left clearfix">
                          <li className="navbar-top-fullname"><span className="mobile-hide">{intl.get('@MAIN_LAYOUT.WELCOME')}</span><a style={{ textDecoration: 'underline' }} href="#/adminconsole/user/profile">{userlogined.fullname}</a> {userlogined.staffNo==="12240"||userlogined.staffNo==="12132"? ` (${sessionStorage.getItem('accessChannel')||0})`:""}</li>
                          <li className="mobile-hide">{intl.get('@MAIN_LAYOUT.LOGINTIME')} {moment(userlogined.login_last_try).format("YYYY-MM-DD HH:mm:ss")}</li>
                          <li style={{ marginRight: '2px' }}><span className="mobile-hide">{intl.get('@MAIN_LAYOUT.LEVEL')}</span><span onClick={this.renderTopBarManually}>{level}</span></li>
                          <li >(<a style={{ textDecoration: 'underline' }} href="#/adminconsole/user/profile?2"><span className="mobile-hide2">K-Rewards 2.0&nbsp;<span style={{fontWeight:"bold"}}>:</span>&nbsp;&nbsp;</span>{score}</a>)</li>
                          <li ><span className="mobile-hide3"><MyPin /></span></li>
                  ...
                  <div className="mobile-right-top">
                    <div className="mobile-favor-inbox">
                      ...
                      <a className="my-favour" href="#/resources/myfavourites" title={intl.get('@MAIN_LAYOUT.MY-FAVOUR')}>&nbsp;</a>
                      <Badge count={inboxNotice} dot={inboxNotice>0}>
                        <a className="my-inbox" href="#/resources/myinbox" title={intl.get('@MAIN_LAYOUT.MY-INBOX')}>&nbsp;</a>
                      </Badge>
                    </div>
                  </div>

                  <div className="lang">
                    <div className="lang-current" onClick={this.handleLocaleClick}>
                      {/* eslint-disable-next-line */}
                      <a style={{color:'#fff'}}>{sessionStorage.getItem('lang')==='zh_TW'? (accessMode===3?'E':'ENG'):(accessMode===3?'中':'中 文')}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ zIndex: 999 }} hidden={menuHidden}>
                    ...
                    onClick={(subs)=>{this.setState(state=>({ menuHidden: true }))}}
                    // onOpenChange={(subs)=>{this.setState(state=>({ menuHidden: (subs.length===0? true : false) }))}}
                    mode="vertical-right"
                    >
                      {loadingMenu? <Spin style={{ width: '220px', padding: '16px' }} tip="Loading..." /> : option_json.map((ioption) => this.loadMenuOption(ioption))}
                      
                      <Menu.Divider />
                      {!sessionStorage.getItem('accessChannel')||sessionStorage.getItem('accessChannel')==='4'? null:
                        (
                          <Menu.Item className="nav-item" key={99} onClick={this.handleLogout}>
                            {intl.get('@MAIN_LAYOUT.LOGOUT')}
                          </Menu.Item>
                        )
                      }
                  ...
                  <div className="container navbar-bottom">
                    <div className="logo clearfix">
                      <a href="#/home"><img src={sessionStorage.getItem('photo') + 'logo.png'} alt="logo" /></a>
                    </div>
                    <div className="navbar-bottom-link" style={{ float: 'left', padding: '0.5em 1.5em 0'}}>
                      {/* <img className="logo-100-yr" onClick={()=>window.open("https://www.csd.gov.hk/100a/", '_blank')} alt="100_years" src={celebrate100_logo} /> */}
                    </div>
                    <div className="navbar-bottom-link" style={{ paddingTop: '0.5em' }}>
                      <ul className="clearfix">
                        {/* eslint-disable-next-line */}
                        <li style={{ borderLeft:'' }}><a href="#/resources/mydownload" className="my-download">{intl.get('@GENERAL.DOWNLOAD')}</a></li>
                        <li style={{ borderLeft:'' }}><a href="#/resources/myfavourites" className="my-favour">{intl.get('@MAIN_LAYOUT.MY-FAVOUR')}</a></li>
                        <li style={{ borderLeft:'' }}>
                        <Badge count={inboxNotice} dot={inboxNotice>0}>
                          <a href="#/resources/myinbox" className="my-inbox">{intl.get('@MAIN_LAYOUT.MY-INBOX')}</a>
                        </Badge>
                        </li>
                        <li><a href="#/adminconsole" className="admin-console">{intl.get('@MAIN_LAYOUT.ADMIN-CONSOLE')}</a></li>
                        <li className="search" hidden={sessionStorage.getItem('accessChannel')!=='1'} >
                            <fieldset name="search-box">
                              <Input.Search name="search-input" onSearch={this.onSearch} allowClear placeholder={intl.get('@MAIN_LAYOUT.SEARCH')} />
                            </fieldset>
                        </li>
                      </ul>
                    </div>
                ...
                <Content style={{ margin: '0px 0px' }}>
                  ...
                  <Router>
                    <Switch>
                      <AuthenticatedRoute path="/home" exact render={()=><HomeLayout handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resourcedetails" render={()=><ResourcesDetails handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resources/latestnews" render={()=><ResourcesLatestNews handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/miniblog/home" render={()=><MiniblogHome handleScoring={this.handleScoring} />} />    
                      <AuthenticatedRoute path="/miniblog/details" render={()=><PostDetails handleScoring={this.handleScoring} />} />
                      <AuthenticatedRoute path="/miniblog/myblog" render={() => <MiniblogMyBlog />} />
                      <AuthenticatedRoute path="/miniblog/post/new" render={()=><PostCreator /> } />
                      <AuthenticatedRoute path="/miniblog/post/modify" render={()=><PostEditor />} />
                      <AuthenticatedRoute path="/newscorner/home" render={()=><NewsCornerHome handleScoring={this.handleScoring} />} />
                      <AuthenticatedRoute path="/specialCollection/home" render={()=><SpecialCollectionHome handleScoring={this.handleScoring} />} />
                      <AuthenticatedRoute path="/specialCollection/post/new" render={()=><SpecialCollectionPostCreator /> } />
                      <AuthenticatedRoute path="/specialCollection/post/modify" render={()=><SpecialCollectionPostEditor />} />
                      <AuthenticatedRoute path="/specialCollection/mySpecialCollection" render={() => <SpecialCollectionMySpecialCollection />} />
                      <AuthenticatedRoute path="/elearning/home" render={() => <ElearningHome />} />
                      <AuthenticatedRoute path="/elearning/quiz_list" render={() => <ElearningQuizList />} />
                      <AuthenticatedRoute path="/elearning/quiz" render={() => <ElearningQuiz />} />
                      <AuthenticatedRoute path="/elearning/quiz_result" render={() => <ElearningQuizResult />} />
                      <AuthenticatedRoute path="/wowza/index" render={() => <WowzaHome />} />
                      <AuthenticatedRoute path="/resources/category" render={() => <ResourcesCate handleScoring={this.handleScoring} selCate={this.state.selCate} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resources/kmarket" render={() => <ResourcesShowAll handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resources/ksquare" render={() => <ResourcesShowAll handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resources/wisdomgallery" render={() => <ResourcesShowAll handleScoring={this.handleScoring} handleCateShortcut={this.handleCateShortcut} />} />
                      <AuthenticatedRoute path="/resources/myfavourites" render={() => <MyFavourites />} />
                      <AuthenticatedRoute path="/resources/myinbox" render={() => <MyInbox />} />
                      <AuthenticatedRoute path="/resources/mydownload" render={() => <MyDownload />} />
                      <AuthenticatedRoute path="/adminconsole" render={() => <AdminconsoleLayout handleScoring={this.handleScoring} /> } />
                      {/* {sessionStorage.getItem('accessChannel')==='1'? <AuthenticatedRoute path="/seniorofficerlist" render={() => <SeniorOffrList /> } />: null} */}
                      <AuthenticatedRoute path="/seniorofficerlist" render={() => <SeniorOffrList /> } />
                      <AuthenticatedRoute path="/kc" render={() => <ForumRouter /> } />
                      <AuthenticatedRoute path="/mobileappdwnld" render={() => <MobileAppPage /> } />
                      <AuthenticatedRoute path="/faq" render={() => <FAQPage /> } />
...
class NotFoundPage extends React.Component{
  render(){
    return(
      ...
      extra={<Button type="primary" href="#/home">{intl.get("@MAIN_LAYOUT.BACK-HOME")}</Button>}
      />
    )
  }
}
  ...
  render(){
    ...
    return(
      <Skeleton active loading={loading}>
        ...
        extra={<Button type="primary" onClick={()=>window.location.assign(window.origin)} >Back to CSD Portal</Button>}
        />
      </Skeleton>
