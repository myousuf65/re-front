...
export default Form.create()(
  class ElearningCreateQuiz extends Component {
    constructor(props) {
      super(props);
      this.state = {
          ...
          const values = {
            ...
            publishAt:
              fieldsValues["isPublic"] === 0
                ? null
                : moment(fieldsValues["publishAt"]).format(
                    "YYYY-MM-DD HH:mm:ss"
                  ),
          ...
          fetchData(createPost_url, "post", values, (response) => {
            ...
            if (response.ifSuccess) {
              ...
              if (res.status === 200) {
                ...
                message.error(
                  "Sorry, post creation was rejected by server.",
                  1
                );
              }
            } else {
        ...
        <div>
          <div className="mini-blog-header">
            <div className="container clearfix">
              ...
              <a
                href="#/elearning/create_quiz"
                className="btn-elearning"
                style={{ width: "160px" }}
              >
                {intl.get("@E_LEARNING.CREATE_QUIZ")}
              </a>
            </div>
          </div>
                      ...
                      >
                        ...
                        >
                          {getFieldDecorator("postTitle", {
                            ...
                            initialValue: quizOptions.postTitle,
                          })(
                            <Input
                        ...
                        {/* access channel */}
                        <Form.Item
                          label={intl.get("@RES_DRAWER_INFO.ACCESS-CHANNEL")}
                        >
                          {getFieldDecorator("accessChannel", {
                            rules: [
                              {
                                required: true,
                                message: intl.get("@GENERAL.REQUIRED"),
                              },
                            ],
                            initialValue: quizOptions.accessChannel,
                          })(
                        ...
                        {/* access rule */}
                        <Form.Item
                          label={intl.get("@RES_MANAGEMENT.ACCESS-RULE")}
                        >
                          {getFieldDecorator("accessRuleId", {
                            ...
                            initialValue: quizOptions.accessRuleId,
                          })(
                            <Select
                        ...
                        <Form.Item label={intl.get("@E_LEARNING.LIMIT_TIME")}>
                          {getFieldDecorator("timeLimit", {
                            ...
                            initialValue: quizOptions.timeLimit,
                          })(
                            <InputNumber
                              min={1}
                              max={300}
                        ...
                        <Form.Item label={intl.get("@E_LEARNING.PASS_MARK")}>
                          {getFieldDecorator("passMark", {
                            ...
                            initialValue: quizOptions.passMark,
                          })(
                            <InputNumber
                              min={1}
                              max={100}
                        ...
                        <Form.Item label={intl.get("@E_LEARNING.REPEAT_TEST")}>
                          {getFieldDecorator("repeat", {
                            ...
                            initialValue: quizOptions.repeat,
                          })(
                            <InputNumber
                              min={1}
                              max={100}
                        ...
                        <div>
                          ...
                          >
                            {getFieldDecorator("isPublic", {
                              initialValue: quizOptions.isPublic
                                ? !disableTimePicker
                                : false,
                              valuePropName: "checked",
                            })(
