...
export default class NewsCornerTopPosts extends React.Component{
...
class PostCard extends React.Component {
    ...
    render(){
      ...
      //   </div>
        ...
        <Link to={`/miniblog/details/?id=${typeof(iPost.newscorner2)==='undefined'? 0 : iPost.newscorner2.id }`}>
          <Card
          ...
          cover={<div 
            ...
            name="auth-div-img"
            data-alt='0'
            data={typeof(iPost.newscorner2)==='undefined'? null:(iPost.newscorner2.thumbnail)}
            alt="POSTS"
            />}
          hoverable={true}
          title={typeof(iPost.newscorner2)==='undefined'? '':iPost.newscorner2.postTitle}
          actions={[
            <IconText type="eye" text={typeof(iPost.newscorner2)==='undefined'?  0 : iPost.newscorner2.hit} />, 
            <IconText type="like" text={iPost.likes || 0}/>, 
            <IconText type="message" text={iPost.comments || 0}/>
          ]}
          >
          <Card.Meta
            description={<div dangerouslySetInnerHTML={{ __html: typeof(iPost.newscorner2)==='undefined'? '':this.stripHtml(iPost.newscorner2.content) }} />}
          />
          <Tag style={{ marginTop:'8px' }} color="volcano">
            {this.translateCateId(typeof(iPost.newscorner2)==='undefined'? 0 : iPost.newscorner2.categoryId)}
          </Tag>
        </Card>
        </Link>
      )
