...
class PostForm extends Component{    
    ...
    render() {
        ...
        const { username, categoryList, mode, disableTimePicker, radioValue, postCreatorsList, loading, isSuperAdmin , ruleOptions } = this.state;
...
{/* ---------------------------------------------------------------------------- */}
                ...
                {getFieldDecorator('link', {
                    ...
                    <Input disabled={isSuperAdmin?false:true} style={{ lineHeight: 0, maxWidth: '600px' }} prefix={<Icon type="file-text" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder={intl.get('@BOOKMARK.LINK')} allowClear />
                )}
                </Form.Item>    
